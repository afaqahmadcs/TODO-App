...
const INITIAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    workspaceId: "college",
    name: "College Semester Course Project",
    description: "Semester project covering core system architecture, data flow design, and module testing.",
    status: "active",
    progress: 85,
    tasksTotal: 15,
    tasksCompleted: 13,
    deadline: "Next Week",
    focusHours: 42.0,
    techStack: ["TypeScript", "PostgreSQL", "Next.js", "System Design"],
