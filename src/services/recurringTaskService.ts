...
const INITIAL_RECURRING_RULES: RecurringRule[] = [
  {
    id: "rec-rule-shooting-daily",
    title: "Daily Shooting Page Management",
    description: "Daily shooting page and social publishing workflow for reel drops & sound check",
    templateId: "OFFICE_DAILY_CONTENT",
    workspaceId: "office",
  ...
  },
  {
    ...
    title: "Suno Music Visual & Canvas Loop Production",
    description: "Multi-stage visual asset rendering and 4K reactive waveform delivery",
    templateId: "SUNO_MUSIC_VISUAL",
    workspaceId: "office",
    ...
    tags: ["suno-music", "motion-graphics", "visualizer"],
    lastGeneratedDate: null,
  ...
  {
    id: "rec-rule-vlog-daily",
    title: "Daily Vlog B-Roll Ingest & Production",
    description: "Ingest SD cards, rough timeline cut, color grading & YouTube premiere packaging",
    templateId: "PERSONAL_VLOG",
    ...
    tags: ["vlog", "creator", "youtube", "daily-vlog"],
    lastGeneratedDate: null,
